...
/**
 * Created by Denis Rainer on 29/12/2015.
 */
public class SaudacaoActivity extends Activity {
    ...
    public static final String ACTION_EXIBIR_SAUDACAO = "helloworld.ACTION_EXIBIR_SAUDACAO";

    public static final String CATEGORY_SAUDACAO = "helloworld.CATEGORY_SAUDACAO";
    @Override
